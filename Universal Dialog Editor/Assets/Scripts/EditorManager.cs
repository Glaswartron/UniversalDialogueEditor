...
public class EditorManager : MonoBehaviour
{
    ...
    public GameObject ActiveUI
    {
        set
        {
            ...
            if (activeUI == startAndSelectUI)
                controlsText.gameObject.SetActive(false);
            else if (PlayerPrefs.GetInt("ShowControls", 1) == 1)
    ...
    public GameObject ActiveMenu
    {
        set
        {
            ...
            bool showControls = PlayerPrefs.GetInt("ShowControls", 1) == 1;
            if (activeUI != startAndSelectUI && showControls)
                controlsText.gameObject.SetActive(true);
    ...
    [Space(7)]
    public Vector2 autogeneratedStartPartPos;

    [Space(7)]
    // true => Editing Dialogue Part; false => Editing answer!
    public bool editingDialoguePart;

    [HideInInspector] public bool inConnectMode;
    ...
    [HideInInspector] public GameObject selectedConnection;

    [HideInInspector] public int noOfAnswers;
    [HideInInspector] public int noOfConnections;
    ...
    public void LoadDialogue(Dialogue dialogue, string path)
    {
        ...
        if (dialoguePartVisuals.Count == 0
            && PlayerPrefs.GetInt("AutogenerateFirstDialoguePart") == 1)
            CreateDialoguePart(autogeneratedStart: true);
    ...
    /// </summary>
    public void CreateDialoguePart(bool autogeneratedStart = false)
    {
        Vector2 pos = !autogeneratedStart 
            ? (Vector2)mainCam.ScreenToWorldPoint(Input.mousePosition) 
            : autogeneratedStartPartPos;
        ...
        string id = !autogeneratedStart ? "" : "start";
        dpVisual.dialoguePart = new Dialogue.DialoguePart(id, dpVisual.transform.position);
