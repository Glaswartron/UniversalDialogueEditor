...
public class UDSException : Exception
{
    internal static readonly string msg1
          = "DialogueComponent {0} does not contain " +
            "a {1} Property with key '{2}'. Consider checking " +
            "DialogueComponent.HasProperty() before querying the Property";
    ...
    internal static readonly string msg3
              = "Property with key {0} of DialogueComponent {1} exists but can not " +
    ...
    internal static readonly string msg4
        ...
        "UDSDialogueManager.HasGlobalProperty() before querying the Property";
